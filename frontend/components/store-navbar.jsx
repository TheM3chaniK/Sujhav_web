        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-400 -mt-1">Store</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/store" className="flex items-center space-x-2 text-green-400 font-medium">
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 bg-gray-900 border-gray-700">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/orders" className="flex items-center space-x-2 cursor-pointer">
                      <Package className="h-4 w-4" />
                      <span>My Orders</span>
                    </Link>
                  </DropdownMenuItem>
